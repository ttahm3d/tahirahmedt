  ...
  const paragraphs = [
    {
      ...
      text: (
        <>
          I&apos;m a{' '}
          <span className="font-bold text-red-11">Fullstack developer</span>{' '}
          currently working at{' '}
          <span className="font-bold text-red-11">Pricewaterhouse Coopers</span>
          . I&apos;ve always enjoyed working on frontend and learnt backend
          technologies on the job. I&apos;ve a keen{' '}
          <span className="font-bold text-red-11">eye for design</span> and can
          use <span className="font-bold text-red-11">Figma</span> . If not
          working, you will find me spending time on my laptop playing{' '}
          <span className="font-bold text-red-11">chess</span> or watching
          movies.
        </>
      ),
    },
    {
      ...
      text: (
        <>
          ...
          career with <span className="font-bold text-red-11">Wipro</span> as a{' '}
          <span className="font-bold text-red-11">Dotnet Developer</span> where
          ...
          <span className="font-bold text-red-11">Cloud Migration</span> team,
          where we migrated apps from on-premise to{' '}
          <span className="font-bold text-red-11">Microsoft Azure</span>.
        </>
      ),
    },
    {
      ...
      text: (
        <>
          ...
          <span className="font-bold text-red-11">formula 1</span>. I used to be
          ...
          both games. I&apos;m a{' '}
          <span className="font-bold text-red-11">foodie</span> in my own way -
          one who loves south indian cusine especially the&nbsp;
          <span className="font-bold text-red-11">darshini</span> culture. like
